...
public class AdminMonitorPersistenceImpl extends BasePersistenceImpl<AdminMonitor>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USER = new FinderPath(AdminMonitorModelImpl.ENTITY_CACHE_ENABLED,
			AdminMonitorModelImpl.FINDER_CACHE_ENABLED, AdminMonitorImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USER = new FinderPath(AdminMonitorModelImpl.ENTITY_CACHE_ENABLED,
			AdminMonitorModelImpl.FINDER_CACHE_ENABLED, AdminMonitorImpl.class,
	 ...
	 */
	@Override
	public List<AdminMonitor> findByUser(long userId) {
	 ...
	 */
	@Override
	public List<AdminMonitor> findByUser(long userId, int start, int end) {
	...
	public List<AdminMonitor> findByUser(long userId, int start, int end,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AdminMonitor adminMonitor : list) {
					if ((userId != adminMonitor.getUserId())) {
						list = null;
	 ...
	 */
	@Override
	public AdminMonitor findByUser_First(long userId,
		OrderByComparator<AdminMonitor> orderByComparator)
		throws NoSuchAdminMonitorException {
		AdminMonitor adminMonitor = fetchByUser_First(userId, orderByComparator);
	 ...
	 */
	@Override
	public AdminMonitor fetchByUser_First(long userId,
		OrderByComparator<AdminMonitor> orderByComparator) {
		List<AdminMonitor> list = findByUser(userId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public AdminMonitor findByUser_Last(long userId,
		OrderByComparator<AdminMonitor> orderByComparator)
		throws NoSuchAdminMonitorException {
		AdminMonitor adminMonitor = fetchByUser_Last(userId, orderByComparator);
	 ...
	 */
	@Override
	public AdminMonitor fetchByUser_Last(long userId,
		OrderByComparator<AdminMonitor> orderByComparator) {
		...
		List<AdminMonitor> list = findByUser(userId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public AdminMonitor[] findByUser_PrevAndNext(long monitorId, long userId,
		OrderByComparator<AdminMonitor> orderByComparator)
		throws NoSuchAdminMonitorException {
		AdminMonitor adminMonitor = findByPrimaryKey(monitorId);
		...
		try {
			...
			array[0] = getByUser_PrevAndNext(session, adminMonitor, userId,
					orderByComparator, true);

			array[1] = adminMonitor;

			array[2] = getByUser_PrevAndNext(session, adminMonitor, userId,
	...
	protected AdminMonitor getByUser_PrevAndNext(Session session,
		AdminMonitor adminMonitor, long userId,
		OrderByComparator<AdminMonitor> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUser(long userId) {
		for (AdminMonitor adminMonitor : findByUser(userId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(adminMonitor);
		}
	}
	...
	private static final String _FINDER_COLUMN_USER_USERID_2 = "adminMonitor.userId = ?";
	...
	public AdminMonitor updateImpl(AdminMonitor adminMonitor) {
		...
		if (!AdminMonitorModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { adminMonitorModelImpl.getUserId() };
