...
public class adminMonitorModelImpl extends BaseModelImpl<adminMonitor>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ipAddress", Types.BIGINT);
	}

	public static final String TABLE_SQL_CREATE = "create table AMF_adminMonitor (monitorId LONG not null primary key,dateTime DATE null,eventType VARCHAR(75) null,userId LONG,ipAddress LONG)";
