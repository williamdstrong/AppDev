...
public interface AdminMonitorPersistence extends BasePersistence<AdminMonitor> {
	...
	* @return the matching admin monitors
	*/
	public java.util.List<AdminMonitor> findByE_U(java.lang.String eventType,
		long userId);
	...
	* @throws NoSuchAdminMonitorException if a matching admin monitor could not be found
	*/
	public AdminMonitor findByE_U_First(java.lang.String eventType,
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator<AdminMonitor> orderByComparator)
		throws NoSuchAdminMonitorException;
	...
	* @return the first matching admin monitor, or <code>null</code> if a matching admin monitor could not be found
	*/
	public AdminMonitor fetchByE_U_First(java.lang.String eventType,
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator<AdminMonitor> orderByComparator);
	...
	* @throws NoSuchAdminMonitorException if a matching admin monitor could not be found
	*/
	public AdminMonitor findByE_U_Last(java.lang.String eventType, long userId,
		com.liferay.portal.kernel.util.OrderByComparator<AdminMonitor> orderByComparator)
		throws NoSuchAdminMonitorException;
	...
	* @return the last matching admin monitor, or <code>null</code> if a matching admin monitor could not be found
	*/
	public AdminMonitor fetchByE_U_Last(java.lang.String eventType,
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator<AdminMonitor> orderByComparator);
	...
	* @param userId the user ID
	*/
	public void removeByE_U(java.lang.String eventType, long userId);
	...
	* @return the number of matching admin monitors
	*/
	public int countByE_U(java.lang.String eventType, long userId);
	...
	* @return the matching admin monitors
	*/
	public java.util.List<AdminMonitor> findByUser(long userId);
	...
	* @return the range of matching admin monitors
	*/
	public java.util.List<AdminMonitor> findByUser(long userId, int start,
		int end);
